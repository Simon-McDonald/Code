...
void Renderer::Initialise(GeometryShader *geometryShader) {
    ...
    glBufferData(GL_ARRAY_BUFFER, (this->pointCounter * sizeof (GLfloat) * (numDims + numCols))/*sizeof(worldArray)*/, (GLfloat*) this->pointArray/*worldArray*/, GL_STATIC_DRAW);

	glGenBuffers(1, &this->ebo);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, this->ebo);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, (this->polygonCounter * sizeof (GLuint) * 3)/*sizeof(indices)*/, (GLuint*) this->polygonArray/*indices*/, GL_STATIC_DRAW);
